...
const double CHASSIS_RPM_TO_RAD_PER_SEC = (1.0 / 60.0) * 2.0 * M_PI / CHASSIS_MOTOR_PROPOTION;
const double CHASSIS_TICK_TO_RAD = (1.0 / 8192.0) * 2.0 * M_PI / CHASSIS_MOTOR_PROPOTION;
