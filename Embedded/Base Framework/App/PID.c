...
float PID_Get_Result(PID_Structure *PID_Handler)
{
	...
	PID_Handler->Result = (PID_Handler->Kp) * Error + (PID_Handler->Ki * PID_Handler->I_Sum) + (PID_Handler->Kd * (Error + PID_Handler->User - PID_Handler->Collect[1])) + (PID_Handler->Offset);
