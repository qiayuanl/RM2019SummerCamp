...
for i in range(1, 8):  # col
    for j in range(1, 10):  # row
        ...
        # Uncomment this block if origin is at Tag 62
        #
        ...
        print(
            '''<node pkg="tf2_ros" type="static_transform_publisher" name=\"map_tag_{tag_id}\" args=\"{x_offset} {y_offset} 0 0 0 1.571 map tag_{tag_id}\" />'''
